...
from game_agent import (MinimaxPlayer, AlphaBetaPlayer, custom_score,
                        custom_score_2, custom_score_03, custom_score_04,
                        custom_score_05, custom_score_02)
...
def main():
    ...
    test_agents = [
        ...
        Agent(AlphaBetaPlayer(score_fn=custom_score_03), "AB_Custom_2"),
        Agent(AlphaBetaPlayer(score_fn=custom_score_02), "AB_Custom_3")
    ]
    ...
    '''cpu_agents = [
        Agent(AlphaBetaPlayer(score_fn=improved_score), "AB_Improved"),
        Agent(AlphaBetaPlayer(score_fn=custom_score_05), "AB_Custom_5"),
        Agent(AlphaBetaPlayer(score_fn=open_move_score), "AB_Open"),
        Agent(AlphaBetaPlayer(score_fn=custom_score), "AB_Distance")
    ]'''
